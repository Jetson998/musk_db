...
分支:   main
Commit: (见本次提交 HEAD) — 已移除 Hero Playground 按钮
...
3. 页面会产生的全部跳转（已核对源码）
========================================
A. 出站跳转 —— 全部指向 NewAPI 网关 https://db.muskapis.com，全部 target="_top"（8 处 + 顶栏 2 处 JS 重写）:
...
curl -s https://dubai.muskapis.com | grep -c data-i18n   # 应为 134
